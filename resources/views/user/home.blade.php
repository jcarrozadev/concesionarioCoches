...
@section('content')
        ...
        <div class="container my-5">
            <div class="row g-3">
                @foreach ($carsOffers as $car)
                    <div class="col-sm-12 col-md-4 col-lg-3 mt-5 car-offer" data-car-id="{{ $car->id }}" data-car-name="{{ $car->name }}" data-car-brand="{{ $car->brand_id }}" data-car-color="{{ $car->color_id }}" data-car-year="{{ $car->year }}" data-car-horsepower="{{ $car->horsepower }}" data-car-price="{{ $car->price }}">
    ...
    <section id="carsAll" name="carsAll">
        ...
        <div class="container my-5">
            <div class="row g-3">
                @foreach ($cars as $car)
                    <div class="col-sm-12 col-md-4 col-lg-3 mt-5 card-all" data-car-id="{{ $car->id }}" data-car-name="{{ $car->name }}" data-car-brand="{{ $car->brand_id }}" data-car-color="{{ $car->color_id }}" data-car-year="{{ $car->year }}" data-car-horsepower="{{ $car->horsepower }}" data-car-price="{{ $car->price }}">
