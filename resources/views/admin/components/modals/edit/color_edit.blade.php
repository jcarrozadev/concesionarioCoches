    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-editColor" class="row g-3 needs-validation" action="" method="post" accept-charset="UTF-8" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="col-12">
                        <label class="form-label" for="editColorName">Nombre del color *</label>
                        <input id="editColorName" name="colorName" class="form-control" type="text" placeholder="Añade el nombre del color" required>
                    ...
                    <div class="col-12">
                        ...
                        <input type="color" class="form-control form-control-color" id="editColorHex" name="codigo_hex" value="#000000" required>
                        <div class="valid-feedback">¡Se ve bien!</div>
