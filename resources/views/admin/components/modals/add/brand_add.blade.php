    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-addBrand" class="row g-3 needs-validation" action="" method="post" accept-charset="UTF-8" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="col-12">
                        <label class="form-label" for="addBrandName">Marca de coche *</label>
                        <input id="addBrandName" name="brandName" class="form-control" type="text" placeholder="Añade la marca de coche" required>
